...
class RightSidebar extends React.Component{
    render(){
        ...
        if(otherUsers == undefined){
            outList = "No one really uses this....";
        } else {
                            ...
                            <div class="row">
                                ...
                                <div class="col-8">
                                    ...
                                    <div class="row">
                                        ...
                                        <form method="GET" action="/sort/?sortby=id">
                                            <input type="submit" name="sortby" class="btn btn-outline-primary border border-primary btn-sm " value="id"/>
                                        </form>
                                    </div>
